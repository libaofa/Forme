...
xst -ifn xst.scr
move Ip_Clk_65M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Ip_Clk_65M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Ip_Clk_65M_exdes.ucf Ip_Clk_65M_exdes

echo 'Running map'
map -timing -pr b Ip_Clk_65M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Ip_Clk_65M_exdes -w routed.ncd routed.v
cd ..
