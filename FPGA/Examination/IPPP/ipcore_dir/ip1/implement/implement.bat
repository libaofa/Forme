...
ngdbuild -uc ip1_exdes.ucf ip1_exdes

echo 'Running map'
map -timing -pr b ip1_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ip1_exdes -w routed.ncd routed.v
cd ..
