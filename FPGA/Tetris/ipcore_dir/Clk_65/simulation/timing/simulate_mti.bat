...
vlog -work work Clk_65_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax Clk_65_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.Clk_65_tb work.glbl
