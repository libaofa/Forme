...
xst -ifn xst.scr
move Clk_65_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clk_65_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clk_65_exdes.ucf Clk_65_exdes

echo 'Running map'
map -timing -pr b Clk_65_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clk_65_exdes -w routed.ncd routed.v
cd ..
