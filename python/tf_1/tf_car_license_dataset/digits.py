...
import time
import random
from tiqu import tiqu_, xiaochu
...
"Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "川","蒙","京", "闽", "粤", "苏","沪","浙", "冀","晋","云","新","陕",
"鲁","青","宁","辽","吉","赣","湘","鄂","豫","黑","琼","贵","桂","甘","渝","皖","津","藏")
license_num = ""
...
if __name__ == '__main__' and sys.argv[1] == 'train':
    ...
    # 定义对应维数和各维长度的数组
    input_images = np.array([[0] * SIZE for i in range(input_count)])		#维数 文件数 * 1280
    input_labels = np.array([[0] * NUM_CLASSES for i in range(input_count)])	#维数 文件数 * 34
                ...
                for h in range(0, height):
                    for w in range(0, width):
                        ...
                        if img.getpixel((w, h)) > 230:
                            input_images[index][w + h * width] = 0		#白色设置为0
                        else:
...
if __name__ == '__main__' and sys.argv[1] == 'test':
    ...
    with tf.Session() as sess:
        ...
        for n in range(1,8):
            #path = "C:/Users/Bear/Desktop/tf_1/tf_car_license_dataset/test_images/1/%s.bmp" % (n)
