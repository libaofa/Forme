...
def xiaochu(img,var):
    ...
    for pix in range(7):       
        ...
        if flag == 1:
            cv2.imwrite(r"C:/Users/Bear/Desktop/tf_1/tf_car_license_dataset/test_images/1/%s_%s.bmp"%(str(var),str(num_i)), img_new)
            num_i = num_i + 1
        else:
            break
...
i = 100
dir = r'C:\Users\Bear\Desktop\tf_1\data\image'
path = []
