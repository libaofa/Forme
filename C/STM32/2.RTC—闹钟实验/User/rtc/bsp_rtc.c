...
void Time_Regulate_Get_alarm(struct rtc_time *tm)
{
	  uint32_t temp_num = 0;
	  ...
	  printf("\r\n======================设置闹钟时间==================");
		...
		do 
	  {				
			printf("\r\n  请输入闹钟时钟(Please Set Hours),范围[0~23]，输入字符后请加回车:");
			scanf("%d",&temp_num);
		...
		do 
	  {				
			printf("\r\n  请输入闹钟分钟(Please Set Minutes),范围[0~59]，输入字符后请加回车:");
			scanf("%d",&temp_num);
		...
		do 
	  {				
			printf("\r\n  请输入闹钟秒钟(Please Set Seconds),范围[0~59]，输入字符后请加回车:");
			scanf("%d",&temp_num);
